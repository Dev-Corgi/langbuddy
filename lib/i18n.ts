...
export const i18n = {
  ko: {
    ...
    myPage: {
      ...
      seatingTitle: "언어교환 참여 기록",
      noSeating: "최근 30일간 저장된 언어교환 기록이 없습니다.",
      seatingDetail: "상세 기록 보기",
      round: "라운드",
      table: "테이블",
      with: "함께한 분들",
      stampTitle: "언어교환 스탬프",
  ...
  en: {
    ...
    myPage: {
      ...
      seatingTitle: "Language exchange history",
      noSeating: "No language exchange sessions in the last 30 days.",
      seatingDetail: "View details",
      round: "Round",
      table: "Table",
      with: "Tablemates",
